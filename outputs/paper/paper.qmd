...
## Data Management
In order to conduct an analysis on the various parts of the beauty industry, three separate datasets were used. The Pudding is a digital publication that makes its data sets open to the public @pudd.
